...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tSampletime.setGeometry(QRect(10, 120, 113, 21))
        self.tSampletime.setMaxLength(3)
        self.tLabel = QLineEdit(self.centralwidget)
        self.tLabel.setObjectName(u"tLabel")
        self.tLabel.setGeometry(QRect(10, 170, 113, 21))
        self.tLabel.setMaxLength(30)
        self.textBrowser = QTextBrowser(self.centralwidget)
        self.textBrowser.setObjectName(u"textBrowser")
        self.textBrowser.setGeometry(QRect(10, 30, 151, 31))
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(10, 100, 151, 16))
        self.label_3 = QLabel(self.centralwidget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(140, 120, 151, 16))
        self.label_4 = QLabel(self.centralwidget)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(10, 150, 151, 16))
        self.label_5 = QLabel(self.centralwidget)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(310, 150, 301, 71))
